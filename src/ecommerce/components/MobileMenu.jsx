...
const allTabs = [
  { id: "tabs-1-tab-1", ariaControls: "tabs-1-panel-1", name: "Women" },
  { id: "tabs-1-tab-2", ariaControls: "tabs-1-panel-2", name: "Men" },
];
...
export default function MobileMenu() {
  ...
  return (
   ...
   Entering: "transition-opacity ease-linear duration-300" From:
   "opacity-0" To: "opacity-100" Leaving: "transition-opacity ease-linear
   duration-300" From: "opacity-100" To: "opacity-0" */}
      <div class="fixed inset-0 bg-black bg-opacity-25"></div>
      <div class="fixed inset-0 z-40 flex">
        {/* Off-canvas menu, show/hide based on off-canvas menu state.
     Entering: "transition ease-in-out duration-300 transform" From:
     "-translate-x-full" To: "translate-x-0" Leaving: "transition
     ease-in-out duration-300 transform" From: "translate-x-0" To:
     "-translate-x-full" */}
              ...
              >
                {allTabs.map((myTab) => {
                  return (
                    <Tab
                      {...myTab}
                      onClick={() => setTab(myTab.name.toLocaleLowerCase())}
                      currentTab={tab}
                    />
                  );
                })}
            ...
            {tab === "women" && (
              ...
              >
                <div class="grid grid-cols-2 gap-x-4">
                  {allHighlights.map((hightlight) => {
                    return <Highlight {...hightlight} />;
                  })}
                </div>
                <div>
                  <p
